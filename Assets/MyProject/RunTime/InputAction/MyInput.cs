    ...
    public struct CameraActions
    {
        ...
        public void SetCallbacks(ICameraActions instance)
        {
            if (m_Wrapper.m_CameraActionsCallbackInterface != null)
            {
                ...
                @CameraReset.started -= m_Wrapper.m_CameraActionsCallbackInterface.OnCameraReset;
                @CameraReset.performed -= m_Wrapper.m_CameraActionsCallbackInterface.OnCameraReset;
                @CameraReset.canceled -= m_Wrapper.m_CameraActionsCallbackInterface.OnCameraReset;
            }
